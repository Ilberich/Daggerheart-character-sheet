// Beastform options for the Druid class.
// Each entry follows this schema:
// {
//   name: string               — category name
//   tier: 1|2|3|4              — minimum tier required
//   examples: string           — example animals in parentheses
//   traitBonus: { trait: string, amount: number }  — stat bonus while transformed
//   evasionBonus: number       — added to character's base Evasion
//   attack: {
//     range: "Melee"|"Very Close"|"Close"
//     trait: string            — trait used for attack rolls
//     damage: string           — damage dice expression
//     damageType: "physical"|"magic"
//   }
//   advantages: string[]       — action/reaction roll verbs that gain advantage
//   features: [{ name: string, text: string }]
//   specialCost?: string       — extra cost to transform (Hybrid forms)
// }
...
export const BEASTFORMS = [
...

  {
    ...
    evasionBonus: 2,
    attack: { range: "Melee", trait: "Agility", damage: "d4", damageType: "physical" },
    ...
    features: [
      ...
      {
        name: "Fragile",
        text: "When you take Major or greater damage, you drop out of Beastform.",
      },
    ],
  },

  {
    ...
    evasionBonus: 2,
    attack: { range: "Melee", trait: "Instinct", damage: "d6", damageType: "physical" },
...

  {
    ...
    traitBonus: { trait: "Agility", amount: 1 },
    evasionBonus: 3,
    attack: { range: "Melee", trait: "Agility", damage: "d6", damageType: "physical" },
...

  {
    ...
    evasionBonus: 2,
    attack: { range: "Melee", trait: "Finesse", damage: "d6+1", damageType: "physical" },
...

  {
    ...
    evasionBonus: 1,
    attack: { range: "Melee", trait: "Strength", damage: "d10+4", damageType: "physical" },
    ...
    features: [
      ...
      {
        name: "Thick Hide",
        text: "You gain a +2 bonus to your damage thresholds.",
      },
    ],
  },

  {
    ...
    traitBonus: { trait: "Agility", amount: 1 },
    evasionBonus: 2,
    attack: { range: "Melee", trait: "Agility", damage: "d8+1", damageType: "physical" },
    advantages: ["leap", "navigate", "sprint"],
    features: [
      {
        name: "Carrier",
        text: "You can carry up to two willing allies with you when you move.",
      },
      {
        name: "Trample",
...

  {
    ...
    traitBonus: { trait: "Finesse", amount: 1 },
    evasionBonus: 2,
    attack: { range: "Very Close", trait: "Finesse", damage: "d8+4", damageType: "physical" },
...

  {
    ...
    traitBonus: { trait: "Instinct", amount: 1 },
    evasionBonus: 3,
    attack: { range: "Melee", trait: "Instinct", damage: "d8+6", damageType: "physical" },
    advantages: ["attack", "climb", "sneak"],
    features: [
      {
        name: "Fleet",
        text: "Spend a Hope to move up to Far range without rolling.",
      },
      {
        name: "Takedown",
...

  {
    ...
    traitBonus: { trait: "Finesse", amount: 1 },
    evasionBonus: 3,
    attack: { range: "Melee", trait: "Finesse", damage: "d4+2", damageType: "physical" },
    ...
    features: [
      ...
      {
        name: "Hollow Bones",
        text: "You gain a −2 penalty to your damage thresholds.",
      },
    ],
  },
...

  {
    ...
    traitBonus: { trait: "Strength", amount: 2 },
    evasionBonus: 2,
    attack: { range: "Melee", trait: "Strength", damage: "d12+8", damageType: "physical" },
...

  {
    ...
    evasionBonus: 1,
    attack: { range: "Melee", trait: "Instinct", damage: "d10+7", damageType: "physical" },
    advantages: ["attack", "sneak", "track"],
    features: [
      {
        name: "Physical Defense",
        text: "You gain a +3 bonus to your damage thresholds.",
      },
      {
...

  {
    ...
    evasionBonus: 3,
    attack: { range: "Melee", trait: "Finesse", damage: "d8+6", damageType: "physical" },
...

  {
    ...
    evasionBonus: 4,
    attack: { range: "Melee", trait: "Agility", damage: "d10+6", damageType: "physical" },
...

  {
    ...
    attack: null,
    advantages: [],
    specialCost: "Choose a Tier 1 form — inherit all its traits and features plus bonuses below",
    features: [
      {
        name: "Evolved",
        text: "Pick a Tier 1 Beastform option and become a larger, more powerful version of that creature. While you're in this form, you retain all traits and features from the original form and gain the following bonuses: +6 bonus to damage rolls, +1 bonus to the trait used by this form, +2 bonus to Evasion.",
      },
    ],
  },

  {
    ...
    traitBonus: { trait: "Strength", amount: 2 },
    evasionBonus: 3,
    attack: { range: "Melee", trait: "Strength", damage: "d10+8", damageType: "physical" },
    advantages: [],
    specialCost: "Mark an additional Stress to transform",
    features: [
      {
...

  {
    ...
    traitBonus: { trait: "Strength", amount: 3 },
    evasionBonus: 1,
    attack: { range: "Melee", trait: "Strength", damage: "d12+12", damageType: "physical" },
    advantages: ["locate", "protect", "scare", "sprint"],
    features: [
      {
        name: "Carrier",
        text: "You can carry up to four willing allies with you when you move.",
      },
      {
        name: "Demolish",
      ...
      {
        name: "Undaunted",
        text: "You gain a +2 bonus to all your damage thresholds.",
      },
    ],
  },

  {
    ...
    traitBonus: { trait: "Strength", amount: 3 },
    evasionBonus: 2,
    attack: { range: "Melee", trait: "Strength", damage: "d12+10", damageType: "physical" },
...

  {
    ...
    evasionBonus: 4,
    attack: { range: "Melee", trait: "Finesse", damage: "d10+11", damageType: "physical" },
    advantages: ["attack", "deceive", "locate", "navigate"],
    features: [
      {
        name: "Carrier",
        text: "You can carry up to three willing allies with you when you move.",
      },
      {
        name: "Deadly Raptor",
...

  {
    ...
    evasionBonus: 3,
    attack: { range: "Melee", trait: "Agility", damage: "d10+10", damageType: "physical" },
...

  {
    ...
    attack: null,
    advantages: [],
    specialCost: "Choose a Tier 1 or Tier 2 form — inherit all its traits and features plus bonuses below",
    features: [
      {
        name: "Evolved",
        text: "Pick a Tier 1 or Tier 2 Beastform option and become a larger, more powerful version of that creature. While you're in this form, you retain all traits and features from the original form and gain the following bonuses: +9 bonus to damage rolls, +2 bonus to the trait used by this form, +3 bonus to Evasion, your damage die increases by one size (d6 becomes d8, d8 becomes d10, etc.).",
      },
    ],
  },

  {
    ...
    attack: { range: "Melee", trait: "Strength", damage: "d12+10", damageType: "physical" },
    advantages: [],
    specialCost: "Mark 2 additional Stress to transform",
    features: [
      {
        name: "Hybrid Features",
